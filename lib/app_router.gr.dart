...
abstract class _$AppRouter extends RootStackRouter {
  ...
  final Map<String, PageFactory> pagesMap = {
    ...
    FollowingTabRoute.name: (routeData) {
      return AutoRoutePage<dynamic>(
        routeData: routeData,
...
/// generated route for
/// [FollowingTabScreen]
class FollowingTabRoute extends PageRouteInfo<void> {
  const FollowingTabRoute({List<PageRouteInfo>? children})
      : super(
          FollowingTabRoute.name,
          initialChildren: children,
        );
